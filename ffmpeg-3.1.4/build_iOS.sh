...
lipo -output ./iOS/fat/lib/libavcodec.a  -create \
-arch armv7  ./iOS/armv7/lib/libavcodec.a \
-arch armv7s ./iOS/armv7s/lib/libavcodec.a \
-arch arm64  ./iOS/arm64/lib/libavcodec.a

lipo -output ./iOS/fat/lib/libavdevice.a  -create \
-arch armv7  ./iOS/armv7/lib/libavdevice.a \
-arch armv7s ./iOS/armv7s/lib/libavdevice.a \
-arch arm64  ./iOS/arm64/lib/libavdevice.a

lipo -output ./iOS/fat/lib/libavformat.a  -create \
-arch armv7 ./iOS/armv7/lib/libavformat.a \
-arch armv7s ./iOS/armv7s/lib/libavformat.a \
-arch arm64 ./iOS/arm64/lib/libavformat.a

lipo -output ./iOS/fat/lib/libavutil.a  -create \
-arch armv7 ./iOS/armv7/lib/libavutil.a \
-arch armv7s ./iOS/armv7s/lib/libavutil.a \
-arch arm64 ./iOS/arm64/lib/libavutil.a

lipo -output ./iOS/fat/lib/libswscale.a  -create \
-arch armv7 ./iOS/armv7/lib/libswscale.a \
-arch armv7s ./iOS/armv7s/lib/libswscale.a \
-arch arm64 ./iOS/arm64/lib/libswscale.a

lipo -output ./iOS/fat/lib/libavfilter.a  -create \
-arch armv7 ./iOS/armv7/lib/libavfilter.a \
-arch armv7s ./iOS/armv7s/lib/libavfilter.a \
-arch arm64 ./iOS/arm64/lib/libavfilter.a

lipo -output ./iOS/fat/lib/libavresample.a  -create \
-arch armv7 ./iOS/armv7/lib/libavresample.a \
-arch armv7s ./iOS/armv7s/lib/libavresample.a \
-arch arm64 ./iOS/arm64/lib/libavresample.a
